...
var require_ckeditor = __commonJS({
  "node_modules/@mayasabha/ckeditor4-vue3/dist/ckeditor.js"(exports, module) {
    !function(t, e) {
      ...
      function c(t2, e2) {
        t2.onload = function() {
          this.onerror = this.onload = null, e2(null, t2);
        }, t2.onerror = function() {
          this.onerror = this.onload = null, e2(new Error("Failed to load " + this.src), t2);
        };
      }
      function s(t2, e2) {
        t2.onreadystatechange = function() {
          "complete" != this.readyState && "loaded" != this.readyState || (this.onreadystatechange = null, e2(null, t2));
        };
      }
      function u(t2, e2) {
        return "CKEDITOR" in window ? Promise.resolve(CKEDITOR) : "string" != typeof t2 || t2.length < 1 ? Promise.reject(new TypeError("CKEditor URL must be a non-empty string.")) : (i || (i = u.scriptLoader(t2).then(function(t3) {
          return e2 && e2(t3), t3;
        })), i);
      }
      function l(t2) {
      ...
      function f(t2, e2, n2) {
        return (e2 = function(t3) {
          var e3 = function(t4, e4) {
            if ("object" != l(t4) || !t4) return t4;
            var n3 = t4[Symbol.toPrimitive];
            if (void 0 !== n3) {
              var r2 = n3.call(t4, e4 || "default");
              if ("object" != l(r2)) return r2;
              throw new TypeError("@@toPrimitive must return a primitive value.");
            }
            return ("string" === e4 ? String : Number)(t4);
          }(t3, "string");
          return "symbol" == l(e3) ? e3 : e3 + "";
        }(e2)) in t2 ? Object.defineProperty(t2, e2, { value: n2, enumerable: true, configurable: true, writable: true }) : t2[e2] = n2, t2;
      }
      u.scriptLoader = function(t2) {
        return new Promise(function(e2, n2) {
          !function(t3, e3, n3) {
            var r2 = document.head || document.getElementsByTagName("head")[0], o2 = document.createElement("script");
            "function" == typeof e3 && (n3 = e3, e3 = {}), e3 = e3 || {}, n3 = n3 || function() {
            }, o2.type = e3.type || "text/javascript", o2.charset = e3.charset || "utf8", o2.async = !("async" in e3) || !!e3.async, o2.src = t3, e3.attrs && function(t4, e4) {
              for (var n4 in e4) t4.setAttribute(n4, e4[n4]);
            }(o2, e3.attrs), e3.text && (o2.text = String(e3.text)), ("onload" in o2 ? c : s)(o2, n3), o2.onload || c(o2, n3), r2.appendChild(o2);
          }(t2, function(t3) {
            return i = void 0, t3 ? n2(t3) : window.CKEDITOR ? void e2(CKEDITOR) : n2(new Error("Script loaded from editorUrl doesn't provide CKEDITOR namespace."));
          });
        });
      };
      const p = { name: "ckeditor", render: function() {
        return (0, a.h)("div", {}, [(0, a.h)(this.tagName)]);
      }, props: { modelValue: { type: String, default: "" }, type: { type: String, default: "classic", validator: function(t2) {
        return ["classic", "inline"].includes(t2);
      } }, editorUrl: { type: String, default: "https://cdn.ckeditor.com/4.22.1/standard-all/ckeditor.js" }, config: { type: Object, default: function() {
      } }, tagName: { type: String, default: "textarea" }, readOnly: { type: Boolean, default: null }, throttle: { type: Number, default: 80 } }, mounted: function() {
        var t2 = this;
        u(this.editorUrl, function(e2) {
          t2.$emit("namespaceloaded", e2);
        }).then(function() {
          if (!t2.$_destroyed) {
            var e2 = t2.prepareConfig(), n2 = "inline" === t2.type ? "inline" : "replace", r2 = t2.$el.firstElementChild;
            CKEDITOR[n2](r2, e2);
          }
        }).catch(function(t3) {
          console.log("[ckeditor.js] Error while loading namespace from integrations package", t3);
        });
      }, data: function() {
        return { readyEmitted: false };
      }, beforeDestroy: function() {
        this.instance && this.instance.destroy(), this.$_destroyed = true;
      }, watch: { modelValue: function(t2) {
        this.instance && this.instance.getData() !== t2 && this.instance.setData(t2);
      }, readOnly: function(t2) {
        this.instance && this.instance.setReadOnly(t2);
      } }, methods: { prepareConfig: function() {
        var t2 = this, e2 = this.config ? function(t3) {
        ...
        e2.on = e2.on || {}, void 0 === e2.delayIfDetached && (e2.delayIfDetached = true), null !== this.readOnly && (e2.readOnly = this.readOnly), e2.hasOwnProperty("versionCheck") || (e2.versionCheck = false);
        var n2 = e2.on.instanceReady;
        return e2.on.instanceReady = function(e3) {
          t2.instance = e3.editor, t2.$nextTick().then(function() {
            t2.prepareComponentData(), n2 && n2(e3);
          });
        }, e2;
      }, prepareComponentData: function() {
        var t2 = this, e2 = this.modelValue;
        this.instance.fire("lockSnapshot"), this.instance.setData(e2, { callback: function() {
          t2.$_setUpEditorEvents();
          var n2 = t2.instance.getData();
          e2 !== n2 ? (t2.readyEmitted || (t2.$emit("ready", t2.instance), t2.readyEmitted = true), t2.$emit("update:modelValue", n2)) : t2.readyEmitted || (t2.$emit("ready", t2.instance), t2.readyEmitted = true), t2.instance.fire("unlockSnapshot");
        } });
      }, $_setUpEditorEvents: function() {
        var t2 = this, e2 = this.instance, n2 = function(t3, e3) {
          var n3, r2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
          return function() {
            clearTimeout(n3);
            for (var o2 = arguments.length, i2 = new Array(o2), a2 = 0; a2 < o2; a2++) i2[a2] = arguments[a2];
            n3 = setTimeout(t3.bind.apply(t3, [r2].concat(i2)), e3);
          };
        }(function(n3) {
          var r2 = e2.getData();
          t2.modelValue !== r2 && t2.$emit("update:modelValue", r2, n3, e2);
        }, this.throttle);
        e2.on("change", n2), e2.on("focus", function(n3) {
          t2.$emit("focus", n3, e2);
        }), e2.on("blur", function(n3) {
          t2.$emit("blur", n3, e2);
        });
      } } };
      const y = { install: function(t2) {
        t2.component("ckeditor", p);
      }, component: p };
      return o = o.default;
    })());
  }
